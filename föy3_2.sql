...
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(1, 'İsmail', 'İşeri', 100000, '2014-02-20', 1)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(2, 'Hami', 'Satılmış', 80000, '2014-06-11', 1)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(3, 'Durmuş', 'Şahin', 300000, '2014-02-20', 2)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(4, 'Kağan', 'Yazar', 500000, '2014-02-20', 3)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(5, 'Meryem', 'Soysaldı',500000, '2014-06-11', 3)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(6, 'Duygu', 'Akşehir', 200000, '2014-06-11', 2)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(7, 'Kübra', 'Seyhan', 75000, '2014-01-20', 1)
INSERT INTO calisanlar(calisan_id,ad,soyad,maas,katılmaTarihi,calisan_birim_id) VALUES(8, 'Gülcan', 'Yıldız', 90000, '2014-04-11', 3)
